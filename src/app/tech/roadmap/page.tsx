            ...
            <div className="relative border-l-2 border-white/10 ml-4 space-y-10 pb-4">
              {roadmapItems.map((item, idx) => (
                <div key={idx} className="relative pl-8">
                  <div className={`absolute -left-[21px] top-1 w-10 h-10 rounded-full flex items-center justify-center text-sm shadow-lg border-[4px] border-[#070B14] ${
                    ...
                    <div className="mb-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {item.skills.map((skill, i) => (
                          <span key={i} className="text-xs px-2 py-1 bg-white/5 border border-white/10 rounded-md text-white/80">
                            {skill}
                          </span>
                        ))}
                      </div>
